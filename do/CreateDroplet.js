...
var client =
{
    ...
    createDroplet: function (dropletName, region, imageName, onResponse)
    {
        var data = 
        {
            ...
            "size":"512mb",
            "image":imageName,
            //retrieve the keyid using curl -X GET -H "Content-Type: application/json" -H "Authorization: Bearer $TOKEN" "https://api.digitalocean.com/v2/account/keys"
            "ssh_keys":[6121427],
            "backups":false,
            "ipv6":false,
            "user_data":null,
 ...
 var getIPAddress = function(ipaddress) {
    ...
    fs.writeFile(__dirname + "/../ansible/inventory", "digitalocean ansible_ssh_host=" + ipaddress + " ansible_ssh_user=root ansible_ssh_private_key_file=~/.ssh/id_rsa" + "\n")
     console.log("Digital Ocean IP adress: "+ ipaddress);
 }
