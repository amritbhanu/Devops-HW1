        ...
        console.log("ERROR - " + err);
          ...
          if(data.Reservations && data.Reservations[0].Instances) {
            if(data.Reservations[0].Instances.length > 0 && data.Reservations[0].Instances[0].State.Name == "running") {
              ...
              fs.appendFile(__dirname + "/../ansible/inventory", "aws ansible_ssh_host=" + instance.PublicIpAddress + " ansible_ssh_user=ubuntu ansible_ssh_private_key_file=~/.ssh/id_rsa" + "\n")
